 ...
 */
export declare type Organisation = Message<"zitadel.object.v2.Organisation"> & {
  /**
 ...
 */
export declare type Organization = Message<"zitadel.object.v2.Organization"> & {
  /**
 ...
 */
export declare type RequestContext = Message<"zitadel.object.v2.RequestContext"> & {
  /**
 ...
 */
export declare type ListQuery = Message<"zitadel.object.v2.ListQuery"> & {
  /**
 ...
 */
export declare type Details = Message<"zitadel.object.v2.Details"> & {
  /**
 ...
 */
export declare type ListDetails = Message<"zitadel.object.v2.ListDetails"> & {
  /**
