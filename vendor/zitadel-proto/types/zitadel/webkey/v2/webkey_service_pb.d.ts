 ...
 */
export declare const file_zitadel_webkey_v2_webkey_service: GenFile;

/**
 * @generated from message zitadel.webkey.v2.CreateWebKeyRequest
 */
export declare type CreateWebKeyRequest = Message<"zitadel.webkey.v2.CreateWebKeyRequest"> & {
  /**
   ...
   *
   * @generated from oneof zitadel.webkey.v2.CreateWebKeyRequest.key
   */
  key: {
    /**
     ...
     *
     * @generated from field: zitadel.webkey.v2.RSA rsa = 1;
     */
    value: RSA;
    case: "rsa";
  } | {
     ...
     *
     * @generated from field: zitadel.webkey.v2.ECDSA ecdsa = 2;
     */
    value: ECDSA;
    case: "ecdsa";
  } | {
     ...
     *
     * @generated from field: zitadel.webkey.v2.ED25519 ed25519 = 3;
     */
    value: ED25519;
    case: "ed25519";
...
/**
 * @generated from message zitadel.webkey.v2.CreateWebKeyResponse
 */
export declare type CreateWebKeyResponse = Message<"zitadel.webkey.v2.CreateWebKeyResponse"> & {
  /**
...
/**
 * @generated from message zitadel.webkey.v2.ActivateWebKeyRequest
 */
export declare type ActivateWebKeyRequest = Message<"zitadel.webkey.v2.ActivateWebKeyRequest"> & {
  /**
...
/**
 * @generated from message zitadel.webkey.v2.ActivateWebKeyResponse
 */
export declare type ActivateWebKeyResponse = Message<"zitadel.webkey.v2.ActivateWebKeyResponse"> & {
  /**
...
/**
 * @generated from message zitadel.webkey.v2.DeleteWebKeyRequest
 */
export declare type DeleteWebKeyRequest = Message<"zitadel.webkey.v2.DeleteWebKeyRequest"> & {
  /**
...
/**
 * @generated from message zitadel.webkey.v2.DeleteWebKeyResponse
 */
export declare type DeleteWebKeyResponse = Message<"zitadel.webkey.v2.DeleteWebKeyResponse"> & {
  /**
...
/**
 * @generated from message zitadel.webkey.v2.ListWebKeysRequest
 */
export declare type ListWebKeysRequest = Message<"zitadel.webkey.v2.ListWebKeysRequest"> & {
};
...
/**
 * @generated from message zitadel.webkey.v2.ListWebKeysResponse
 */
export declare type ListWebKeysResponse = Message<"zitadel.webkey.v2.ListWebKeysResponse"> & {
  /**
   * @generated from field: repeated zitadel.webkey.v2.WebKey web_keys = 1;
   */
  webKeys: WebKey[];
};
...
export declare const WebKeyService: GenService<{
   ...
   *   - `iam.web_key.write`
   *
   * @generated from rpc zitadel.webkey.v2.WebKeyService.CreateWebKey
   */
  createWebKey: {
    methodKind: "unary";
   ...
   *   - `iam.web_key.write`
   *
   * @generated from rpc zitadel.webkey.v2.WebKeyService.ActivateWebKey
   */
  activateWebKey: {
    methodKind: "unary";
   ...
   *   - `iam.web_key.delete`
   *
   * @generated from rpc zitadel.webkey.v2.WebKeyService.DeleteWebKey
   */
  deleteWebKey: {
    methodKind: "unary";
   ...
   *   - `iam.web_key.read`
   *
   * @generated from rpc zitadel.webkey.v2.WebKeyService.ListWebKeys
   */
  listWebKeys: {
    methodKind: "unary";
