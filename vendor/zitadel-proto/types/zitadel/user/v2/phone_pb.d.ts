 ...
 */
export declare type SetHumanPhone = Message<"zitadel.user.v2.SetHumanPhone"> & {
  /**
 ...
 */
export declare type HumanPhone = Message<"zitadel.user.v2.HumanPhone"> & {
  /**
   * @generated from field: string phone = 1;
   */
  phone: string;
 ...
 */
export declare type SendPhoneVerificationCode = Message<"zitadel.user.v2.SendPhoneVerificationCode"> & {
};
 ...
 */
export declare type ReturnPhoneVerificationCode = Message<"zitadel.user.v2.ReturnPhoneVerificationCode"> & {
};
