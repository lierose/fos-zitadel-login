...
describe("OpenTelemetry Integration", () => {
  ...
  beforeAll(async () => {
    ...
    mockZitadel = await new GenericContainer("node:20-alpine")
      ...
      .withCopyFilesToContainer([{ source: path.join(TEST_DIR, "mock-zitadel-server.js"), target: "/app/server.js" }])
      .withBindMounts([{ source: OUTPUT_DIR, target: "/tmp/otel" }])
      .withEnvironment({
        PORT: "8080",
        OUTPUT_DIR: "/tmp/otel",
  ...
  describe("Traces", () => {
    ...
    describe("Span Attributes", () => {
      ...
      it(
        "contains custom test.attribute",
        () => {
      ...
      it(
        "contains custom test.timestamp",
        () => {
    ...
    describe("Span Status", () => {
      ...
      it(
        "contains error message on failed spans",
        () => {
    ...
    describe("Span Hierarchy", () => {
      ...
      it(
        "has child spans linked to parent",
        () => {
    ...
    describe("Span Filtering", () => {
      it(
        "HTTP instrumentation excludes /healthy",
        () => {
      ...
      it(
        "HTTP instrumentation excludes /ready",
        () => {
          const tracesContent = readTraces();
          const traceObjects = tracesContent
            .split("\n")
    ...
    describe("Span Events", () => {
      ...
      it(
        "contains exception.type attribute",
        () => {
      ...
      it(
        "contains exception.message attribute",
        () => {
      ...
      it(
        "contains exception.stacktrace attribute",
        () => {
    ...
    describe("gRPC Spans", () => {
      ...
      it(
        "contains rpc.service attribute",
        () => {
      ...
      it(
        "contains server.address attribute",
        () => {
      ...
      it(
        "contains rpc.grpc.status_code attribute",
        () => {
    ...
    describe("Trace Propagation", () => {
      it(
        "propagates traceparent to backend calls",
        () => {
      ...
      it(
        "maintains trace ID consistency",
        () => {
          const requests = readCapturedHeaders();
          const backendCalls = requests.filter((r) => r.traceparent !== null);
    ...
    describe("Resource Attributes", () => {
      ...
      it(
        "contains process.runtime.version",
        () => {
      ...
      it(
        "contains container.id when running in container",
        () => {
  ...
  describe("Metrics", () => {
    ...
    describe("Runtime Metrics", () => {
      it(
        "exposes nodejs_eventloop_utilization",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes nodejs_eventloop_delay",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes v8js_memory_heap_limit",
        async () => {
          const response = await fetch(prometheusUrl);
    ...
    describe("HTTP Metrics", () => {
      ...
      it(
        "exposes http_server_duration_sum",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes http_server_duration_count",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes http_server_duration_bucket",
        async () => {
          const response = await fetch(prometheusUrl);
    ...
    describe("Application Metrics", () => {
      it(
        "exposes http_server_requests_total",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes http_server_active_requests",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes login_auth_attempts_total",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes login_auth_successes_total",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes login_session_creation_duration",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes http_server_response_status_total",
        async () => {
          const response = await fetch(prometheusUrl);
    ...
    describe("Custom Test Metrics", () => {
      it(
        "exposes otel_test_requests_total",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "exposes otel_test_duration_seconds",
        async () => {
          const response = await fetch(prometheusUrl);
    ...
    describe("Metric Labels", () => {
      it(
        "includes method label on auth metrics",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "includes organization label on auth metrics",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "includes route label on request metrics",
        async () => {
          const response = await fetch(prometheusUrl);
      ...
      it(
        "includes success label on session metrics",
        async () => {
          const response = await fetch(prometheusUrl);
  ...
  describe("Logs", () => {
    ...
    describe("Log Content", () => {
      it(
        "contains OTEL test log message",
        () => {
      ...
      it(
        "contains test completed log message",
        () => {
      ...
      it(
        "contains severity number 9 for INFO",
        () => {
    ...
    describe("Log-Trace Correlation", () => {
      it(
        "includes traceId in log records",
        () => {
      ...
      it(
        "includes spanId in log records",
        () => {
      ...
      it(
        "includes trace_flags attribute",
        () => {
    ...
    describe("Log Attributes", () => {
      ...
      it(
        "includes custom test attribute",
        () => {
...
describe("OpenTelemetry Disabled", () => {
  ...
  describe("Metrics Endpoint", () => {
    it(
      "metrics endpoint is not available when OTEL is disabled",
      async () => {
  ...
  describe("Logging", () => {
    ...
    it(
      "does not contain OTEL SDK initialization logs",
      async () => {
        const logOutput = await getContainerLogs(loginApp);
...
describe("Log Level Configuration", () => {
  describe("OTEL Disabled", () => {
    describe("LOG_LEVEL=debug", () => {
      ...
      it(
        "includes info level logs in console",
        async () => {
          const logOutput = await getContainerLogs(loginApp);
    ...
    describe("LOG_LEVEL=warn", () => {
      ...
      it(
        "does not include info level logs in console",
        async () => {
          const logOutput = await getContainerLogs(loginApp);
      ...
      it(
        "does not include debug level logs in console",
        async () => {
          const logOutput = await getContainerLogs(loginApp);
  ...
  describe("OTEL Enabled", () => {
    ...
    describe("LOG_LEVEL=debug", () => {
      ...
      it(
        "exports logs to OTLP collector",
        () => {
      ...
      it(
        "includes info level logs in OTLP export",
        () => {
          const logs = fs.readFileSync(path.join(logOutputDir, "logs.json"), "utf-8");
          expect(logs).toContain('"severityText":"info"');
        },
    ...
    describe("LOG_LEVEL=warn", () => {
      ...
      it(
        "does not export info level logs to OTLP",
        () => {
      ...
      it(
        "does not export debug level logs to OTLP",
        () => {
          const logsPath = path.join(logOutputDir, "logs.json");
          if (fs.existsSync(logsPath)) {
            const logs = fs.readFileSync(logsPath, "utf-8");
