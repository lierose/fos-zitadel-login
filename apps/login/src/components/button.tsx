...
export const getButtonClasses = (size: ButtonSizes, variant: ButtonVariants, color: ButtonColors) =>
  clsx({
    ...
    "shadow hover:shadow-xl active:shadow-xl disabled:border-none disabled:bg-gray-300 disabled:text-gray-600 disabled:shadow-none disabled:cursor-not-allowed disabled:dark:bg-gray-600 disabled:dark:text-gray-400":
    ...
    "bg-warn-light-500 dark:bg-red-600 hover:bg-warn-light-400 hover:dark:bg-red-500 text-white dark:text-white":
      variant === ButtonVariants.Primary && color === ButtonColors.Warn,
