      ...
      {!!identityProviders?.length &&
        identityProviders?.map((idp, index) => {
          ...
          if (type === IdentityProviderType.GOOGLE) {
            return (
              <form action={action} key={`idp-${index}`} className="flex">
                <input type="hidden" name="id" value={id} />
                <input type="hidden" name="provider" value={idpTypeToSlug(type)} />
                <input type="hidden" name="requestId" value={requestId} />
                <input type="hidden" name="organization" value={organization} />
          ...
          if (type === IdentityProviderType.GITHUB || type === IdentityProviderType.GITHUB_ES) {
            return (
              <form action={action} key={`idp-${index}`} className="flex">
                <input type="hidden" name="id" value={id} />
                <input type="hidden" name="provider" value={idpTypeToSlug(type)} />
          ...
          return renderIDPButton(idp, index);
        })}
